...
### 20. 🌐 公网 IP 分配策略审计与修复：宿主代答、别名回收与 ICMP 透传 (Public IPv4 Ownership - v1.20.11)
...
- **涉及文件**：`backend/internal/lxc/{ipv6,portmap}.go`、`backend/internal/kvm/kvm.go`（分配变更后同步回收/守卫）。
