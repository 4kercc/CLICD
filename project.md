...
### 4. 🤖 原生内置 Telegram Bot 模块 (v1.20.4)
...
### 7. 🛡️ LXC 硬件 MAC 固化与 IP 防漂移 (v1.20.5)
...
### 8. 🌐 NAT 子网过滤与防 Docker 网桥干扰 (v1.20.5)
...
### 10. 🚀 容器/虚拟机预设初始化命令 (Init Script) (v1.20.7)
...
### 12. 💿 KVM Windows ISO 挂载防呆与 `__invalid_image_id__` 启动报错修复 (v1.20.7)
- **根因分析**：
...
### 13. ⚡ Usage 资源指标 5 秒硬超时与列表渲染解耦 (v1.20.7)
...
### 14. 🪟 创建向导「选 Windows 却装出 Debian 12」根因修复 (v1.20.8)
...
### 15. ⏱️ 「一直卡在关机中 / 无法删除」任务假死修复 (v1.20.8)
...
### 17. 🧩 第三方 WinPE / WePE 镜像无法添加修复 (v1.20.8)
...
### 18. 🌐 英文界面残留中文清理与 i18n 覆盖补全 (v1.20.8)
...
### 19. 💿 额外挂载光盘（独立光驱）+ 服务器镜像选择器 (v1.20.8)
- **需求背景**：
